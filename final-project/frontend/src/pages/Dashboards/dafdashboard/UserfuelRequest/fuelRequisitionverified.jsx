...
const FuelRequisitionForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchRequisitions = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/fuel-requisition/verifiedfuel`);
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/fuel-requisition/approve/${selectedRequest._id}`, {
            approvedBy: {
    ...
    <div className="fuel-requisition-form">
      ...
      {selectedRequest && (
        <div className="fuel-request-details-overlay">
          ...
          <button type="button" className='verify-btn' onClick={handleApproveSubmit}>Approve</button>
          ...
          <div className="fuel-img-logo">
                 <img src="/image/logo2.png" alt="Logo" className="log"   />
                   ...
                   <h2>Fuel Requisition Form</h2> <hr />
