...
const handleApproveSubmit = async (e) => {
  ...
  if (!isSigned) {
    ...
    Swal.fire({
      ...
      text: 'You must sign before approving.',
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      try {
        // Forward the updated request to approve it
        ...
        Swal.fire({
          title: 'Success!',
          text: 'Fuel order approved successfully',
          icon: 'success',
          confirmButtonText: 'OK',
          customClass: {
            popup: 'custom-swal', // Apply custom class to the popup
...
<h4>DAF Office</h4>
  ...
  <div className="daf-signature">
    <h4>DG Office</h4>
<label htmlFor="dgName">Approved By:</label>
