  ...
  if (validateLoginForm()) {
    ...
    try {
      ...
      if (res.data.requires2FA) {
        // Navigate immediately — no need to wait for user confirmation
        ...
        else if (role === 'DAF') navigate('/DAF');
        else if (role === 'DG') navigate('/DG');
...
<div class="input-container">
 ...
 <div className="login-password-wrapper">
    ...
    />
    <span onClick={() => setShowPassword(!showPassword)} className="login-toggle-password-icon">
