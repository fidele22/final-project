...
<input  type="tel" class="input-field" value={email} onChange={(e) => setEmail(e.target.value)} placeholder=" Email address" />
...
<input type={showPassword ? 'tel' : 'password'} class="input-field" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password" />
